...
class Config:
    ...
    email_sender_name: str = "Daily Stock Analysis"  # sender display name
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            email_sender_name=os.getenv('EMAIL_SENDER_NAME', 'Daily Stock Analysis'),
    ...
    def _parse_market_review_region(cls, value: str) -> str:
        ...
        if v in ('cn', 'us', 'ca', 'both', 'us_ca'):
            return v
        logging.getLogger(__name__).warning(
            f"MARKET_REVIEW_REGION value '{value}' is invalid, falling back to 'cn' (valid: cn / us / ca / both / us_ca)"
        )
        return 'cn'
